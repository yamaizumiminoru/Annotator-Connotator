...
function buildJudgePrompt() {
  return [
    ...
    "",
    "Schema:",
    '{"judgments":[{"id":"judge-1","componentLexicalBand":"beginner|intermediate|advanced","lexicalTriggerWords":["word"],"contextualMeaningBand":"beginner|intermediate|advanced","domainTerm":false,"domainTermConfidence":"high|medium|low","annotationValueByBand":{"beginner":"high|medium|low","intermediate":"high|medium|low","advanced":"high|medium|low"},"meaningType":"literal_lexical|idiom|phrasal_verb|metaphorical_or_extended_sense|reusable_construction|discourse_marker|domain_term|compositional_phrase|other","confidence":"high|medium|low","reason":"at most two concise sentences"}]}',
  ].join("\n");
}
