...
function buildJudgePrompt() {
  return [
    ...
    "4. annotationValueByBand: for beginner, intermediate, and advanced learners separately, rate the educational value of showing this specific annotation target here as high, medium, or low.",
    ...
    "- Never promote a construction, collocation, formula, idiom, or other multiword annotation to advanced-learner value merely because the surface span contains an advanced lexical item. If that lexical item is itself worth teaching, it should be handled as a lexical candidate separately.",
